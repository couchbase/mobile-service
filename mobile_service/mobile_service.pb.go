...
func (*Gateway) Descriptor() ([]byte, []int) {
	return fileDescriptor_mobile_service_ca6269ee6b7f0f17, []int{0}
}
...
func (*Creds) Descriptor() ([]byte, []int) {
	return fileDescriptor_mobile_service_ca6269ee6b7f0f17, []int{1}
}
...
func (*Stats) Descriptor() ([]byte, []int) {
	return fileDescriptor_mobile_service_ca6269ee6b7f0f17, []int{2}
}
...
func (*StatsReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_mobile_service_ca6269ee6b7f0f17, []int{3}
}
...
func (*Empty) Descriptor() ([]byte, []int) {
	return fileDescriptor_mobile_service_ca6269ee6b7f0f17, []int{4}
}
...
func (*MetaKVPath) Descriptor() ([]byte, []int) {
	return fileDescriptor_mobile_service_ca6269ee6b7f0f17, []int{5}
}
...
func (*MetaKVPair) Descriptor() ([]byte, []int) {
	return fileDescriptor_mobile_service_ca6269ee6b7f0f17, []int{6}
}
...
func (*MetaKVPairs) Descriptor() ([]byte, []int) {
	return fileDescriptor_mobile_service_ca6269ee6b7f0f17, []int{7}
}
...
func init() {
	proto.RegisterType((*Gateway)(nil), "mobile_service.Gateway")
	proto.RegisterType((*Creds)(nil), "mobile_service.Creds")
	proto.RegisterType((*Stats)(nil), "mobile_service.Stats")
	proto.RegisterType((*StatsReply)(nil), "mobile_service.StatsReply")
	proto.RegisterType((*Empty)(nil), "mobile_service.Empty")
	proto.RegisterType((*MetaKVPath)(nil), "mobile_service.MetaKVPath")
	proto.RegisterType((*MetaKVPair)(nil), "mobile_service.MetaKVPair")
	proto.RegisterType((*MetaKVPairs)(nil), "mobile_service.MetaKVPairs")
}
...
func (c *mobileServiceClient) MetaKVGet(ctx context.Context, in *MetaKVPath, opts ...grpc.CallOption) (*MetaKVPair, error) {
	out := new(MetaKVPair)
	err := c.cc.Invoke(ctx, "/mobile_service.MobileService/MetaKVGet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mobileServiceClient) MetaKVListAllChildren(ctx context.Context, in *MetaKVPath, opts ...grpc.CallOption) (*MetaKVPairs, error) {
	out := new(MetaKVPairs)
	err := c.cc.Invoke(ctx, "/mobile_service.MobileService/MetaKVListAllChildren", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mobileServiceClient) MetaKVSet(ctx context.Context, in *MetaKVPair, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/mobile_service.MobileService/MetaKVSet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mobileServiceClient) MetaKVAdd(ctx context.Context, in *MetaKVPair, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/mobile_service.MobileService/MetaKVAdd", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mobileServiceClient) MetaKVDelete(ctx context.Context, in *MetaKVPair, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/mobile_service.MobileService/MetaKVDelete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mobileServiceClient) MetaKVRecursiveDelete(ctx context.Context, in *MetaKVPath, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/mobile_service.MobileService/MetaKVRecursiveDelete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mobileServiceClient) MetaKVObserveChildren(ctx context.Context, in *MetaKVPath, opts ...grpc.CallOption) (MobileService_MetaKVObserveChildrenClient, error) {
	stream, err := c.cc.NewStream(ctx, &_MobileService_serviceDesc.Streams[0], "/mobile_service.MobileService/MetaKVObserveChildren", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *mobileServiceClient) SendStats(ctx context.Context, opts ...grpc.CallOption) (MobileService_SendStatsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_MobileService_serviceDesc.Streams[1], "/mobile_service.MobileService/SendStats", opts...)
	if err != nil {
		return nil, err
	}
...
func _MobileService_MetaKVGet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mobile_service.MobileService/MetaKVGet",
	}
...
func _MobileService_MetaKVListAllChildren_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mobile_service.MobileService/MetaKVListAllChildren",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MobileService_MetaKVSet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mobile_service.MobileService/MetaKVSet",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MobileService_MetaKVAdd_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mobile_service.MobileService/MetaKVAdd",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MobileService_MetaKVDelete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mobile_service.MobileService/MetaKVDelete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MobileService_MetaKVRecursiveDelete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mobile_service.MobileService/MetaKVRecursiveDelete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func init() {
	proto.RegisterFile("mobile_service.proto", fileDescriptor_mobile_service_ca6269ee6b7f0f17)
}

var fileDescriptor_mobile_service_ca6269ee6b7f0f17 = []byte{
	// 452 bytes of a gzipped FileDescriptorProto
	,
}
